...
function App() {
 ...
 return <main className="app-shell">
  <aside className="sidebar"><div className="brand-row"><div className="brand-mark">F</div><div className="brand">Forge Agent</div></div>
   ...
   <div className="credits-card"><small>Integração de IA pendente</small><span>O cérebro externo ainda não está conectado.</span><button onClick={updates} disabled={!window.forge}>Verificar atualização</button></div>
  </aside>
