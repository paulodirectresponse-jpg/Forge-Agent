...
app.whenReady().then(()=>{
 ...
 ipcMain.handle('oneai:get',async()=>({baseUrl:'https://api.oneai.network',model:'openai:gpt-5.5',configured:Boolean(await secrets.get('oneai'))}));
